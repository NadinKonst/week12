...
const makeEight = () => {
  ...
  const num2 = 10;
  //Ваш код
  resultEight.innerHTML = num1 % num2;
};
...
const makeNine = () => {
  ...
  const num2 = 100;
  //Ваш код
  resultNine.innerText = num1 % num2;
};
...
const makeTen = () => {
  const str = "Hello";
  //Ваш код
  resultTen.textContent = str.charAt(2);
};
...
const makeEleven = () => {
  ...
  let num1 = 5;
  let num2 = 2;
  resultEleven.innerText = num1 % num2;
};
...
const makeTwelve = () => {
  const str1 = "Hello, ";
  const str2 = "World!";
  resultTwelve.innerHTML = str1 + str2;
  //Ваш код
};
...
const makeTwentyOne = () => {
  //Ваш код
  resultTwentyOne.textContent = Math.random() * 10;
};
...
const makeTwentyThree = () => {
  //Ваш код
  resultTwentyThree.innerHTML = 2 ** 5;
};
...
const makeTwentySeven = () => {
  ...
  let min = 50;
  let max = 100;
  resultTwentySeven.textContent = Math.random() * (100 - 50) + 50;
};
